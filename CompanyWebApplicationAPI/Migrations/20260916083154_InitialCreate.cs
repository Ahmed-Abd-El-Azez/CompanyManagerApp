        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "HR", "Damietta" },
                    { 3, "PR", "Mansoura" },
                    { 4, "Frontend", "Alexandria" }
                });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "Budget", "ProjectName", "StartDate" },
                values: new object[,]
                {
                    { 1, 0f, "E-Commerce System", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 0f, "Mobile App", new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 0f, "Calendar App", new DateTime(2026, 4, 11, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
